...
func (r *TodoItemPostgres) Create(listId int, item backproject.TodoItem) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoItemPostgres) GetAll(userId, listId int) ([]backproject.TodoItem, error) {
	var items []backproject.TodoItem
...
func (r *TodoItemPostgres) GetById(userId, itemId int) (backproject.TodoItem, error) {
	var item backproject.TodoItem
...
func (r *TodoItemPostgres) Update(userId, itemId int, input backproject.UpdateItemInput) error {
