...
func (r *TodoListPostgres) Create(userId int, list backproject.TodoList) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoListPostgres) GetAll(userId int) ([]backproject.TodoList, error) {
	var lists []backproject.TodoList
...
func (r *TodoListPostgres) GetById(userId, listId int) (backproject.TodoList, error) {
	var list backproject.TodoList
...
func (r *TodoListPostgres) Update(userId, listId int, input backproject.UpdateListInput) error {
